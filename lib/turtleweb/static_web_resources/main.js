...
// Hilfsfunktion: Uptime in h/m/s formatieren
...
function showError(message) {
    ...
    elements.bootTime.textContent = `Boot-Zeitpunkt: Fehler`;
...
function updateUI(data) {
    ...
    // Bootzeit berechnen
    const bootTimestamp = Date.now() - data.uptime;
    const bootDate = new Date(bootTimestamp);
    const bootString = bootDate.toLocaleString("de-DE", {
        dateStyle: "short",
        timeStyle: "medium"
    });
    elements.bootTime.textContent = `Boot-Zeitpunkt: ${bootString}`;
